...
<div class="z-50 h-auto bg-indigo-600 flex items-center justify-center px-5 relative" x-data="{showCookieBanner:true}">
    <section class=" fixed w-full p-5 lg:px-24 bottom-0 bg-indigo-600" x-show="showCookieBanner">
        <div class="md:flex items-center -mx-3">
            ...
            <div class="px-3 text-center">
                <button id="btn" class="py-2 px-8 mr-[18rem] bg-green-400 hover:bg-green-500 text-white rounded font-bold text-sm shadow-xl" @click.prevent="showCookieBanner=!showCookieBanner">Принять</button>
            </div>
        </div>
    </section>
</div>
